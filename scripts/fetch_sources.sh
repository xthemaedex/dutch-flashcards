...
echo "1/4  OpenSubtitles Dutch frequency list (hermitdave/FrequencyWords, CC-BY-SA 4.0)"
curl -fL -O "https://raw.githubusercontent.com/hermitdave/FrequencyWords/master/content/2018/nl/nl_50k.txt"

echo "2/4  Wiktionary Dutch extract (kaikki.org, CC-BY-SA 4.0 / GFDL) — 247 MB"
curl -fL -O "https://kaikki.org/dictionary/Dutch/kaikki.org-dictionary-Dutch.jsonl"

echo "3/4  Tatoeba Dutch sentences + NL-EN links + English sentences (CC-BY 2.0 FR)"
...
echo "4/4  FreeDict Dutch-English (GPL-2.0) — optional fallback translations, not used by default"
